...
public class AppConfig {
  ...
  public static String getLaunchUrl() {
    if (isLaunchLocally()) {
      return sPreferences.getString("local_url", "file://assets/jyheffect/index.js");
    }
    return sPreferences.getString("launch_url", "http://127.0.0.1:8080/dist/jyheffect/index.js");
  }
