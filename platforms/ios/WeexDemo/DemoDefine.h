...
#define HOME_URL [NSString stringWithFormat:@"http://%@:8080/dist/jyheffect/index.js", DEMO_HOST]

#define BUNDLE_URL [NSString stringWithFormat:@"file://%@/bundlejs/jyheffect/index.js",[NSBundle mainBundle].bundlePath]
